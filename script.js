...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Assalamu'alaikum Acchan", "Aku punya pertanyaan niiii", "question").then(function () {
    Swal.fire("Jawab jujur yaa sayangg").then(function () {
      Swal.fire("Awasss kalooo boong", "", "error").then(function () {
        ...
        const {
          ...
          const pertanyaan = Swal.fire({
            title: `${nama} kamuu sayang ga sama ${Nu}?`,
            showDenyButton: true,
            ...
            if (result.isConfirmed) {
              Swal.fire(`${Nu} juga sayang banget sama ${nama}`).then(function () {
                Swal.fire({
                  ...
                  val = e.value
                  Swal.fire(`Makasih banget ya bang udah sayang sama ${Nu} ${val}%`).then(function () {
                    Swal.fire({
                      title: `Sekarang ${nama} kangen ga sama ${Nu}?`,
                      showDenyButton: true,
                      showCancelButton: false,
                      ...
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`Huhuhuhuhuhu iya ${Nu} juga kangen bangett samaaa ${nama} , makasihhh yaa :)`).then(function () {
